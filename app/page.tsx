    ...
    <div className="min-h-screen bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 flex flex-col font-sans">
      ...
      <header className="sticky top-0 z-50 border-b border-neutral-200 dark:border-neutral-800 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/terminal">
              <Button variant="outline" className="hidden sm:flex items-center gap-1.5 font-mono text-xs border-emerald-500/40 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/10">
                &gt;_ CLI Mode
              </Button>
            </Link>
            <Link href="/chat">
      ...
      <section className="relative overflow-hidden pt-20 pb-24 px-4 sm:px-6 lg:px-8 text-center max-w-5xl mx-auto flex flex-col items-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center gap-4">
          ...
          <Link href="/terminal">
            <Button size="lg" variant="outline" className="h-12 px-6 rounded-full font-mono text-sm border-emerald-500/40 text-emerald-700 dark:text-emerald-400 hover:bg-emerald-500/10 flex items-center gap-2">
              &gt;_ Open Terminal CLI
            </Button>
          </Link>
          <a
